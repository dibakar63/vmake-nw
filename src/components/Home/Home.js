    ...
    <div className='model'>
      ...
      <div className='slider-header'>
        ...
        <div className='row inner-model-container'>
          <h6>Try one demo image for <span style={{color:"#54BD95" ,textDecoration:"underline"}}>Upload Image</span></h6>
          ...
          <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRc8n0vs_OosxglpAFs_KP4Cp8PGTx3BsIh8A&usqp=CAU' onClick={()=>navigate('/models')}/>
